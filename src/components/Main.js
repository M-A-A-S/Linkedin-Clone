...
import { getArticesAPI } from "../actions";
                ...
                {props.articles.length === 0 ? (
                  ...
                  <Article key={key}>
                    <ShareActor>
                      ...
                      <button>
                        <img src="/images/ellipsis.PNG" alt="" width="20px" />
                      </button>
                    </ShareActor>
                    ...
                    <SocialActions>
                      ...
                      <button>
                        <img
                          src="https://static-exp1.licdn.com/sc/h/9c63smlahzbgqnx5wxaq3faa0"
                          alt=""
                        />
                        <span>share</span>
                      </button>
...
const mapDispatchToProps = (dispatch) => ({
  getArticles: () => dispatch(getArticesAPI()),
});
